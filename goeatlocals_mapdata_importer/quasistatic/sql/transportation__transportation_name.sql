...
indoor INT, bicycle TEXT, foot TEXT, horse TEXT, mtb_scale TEXT, surface TEXT) AS $$
    ...
    FROM (
        ...
        FROM :use_schema.osm_transportation_merge_linestring_gen7
        WHERE zoom_level = 4
        UNION ALL
        ...
        SELECT
            ...
            NULL AS surface, z_order
        FROM :use_schema.osm_highway_linestring_gen2
        ...
        SELECT
            ...
            bicycle, foot, horse, mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_highway_linestring_gen1
        WHERE zoom_level = 11
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL as surface, z_order
        FROM :use_schema.osm_railway_linestring_gen5
        WHERE zoom_level = 8
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_railway_linestring_gen4
        WHERE zoom_level = 9
            AND railway='rail' AND service = '' and usage='main'
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_railway_linestring_gen3
        WHERE zoom_level = 10
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL as surface, z_order
        FROM :use_schema.osm_railway_linestring_gen2
        WHERE zoom_level = 11
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL as surface, z_order
        FROM :use_schema.osm_railway_linestring_gen1
        WHERE zoom_level = 12
            AND railway IN ('rail', 'narrow_gauge', 'light_rail') AND service = ''
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL as surface, z_order
        FROM :use_schema.osm_railway_linestring
        WHERE zoom_level = 13
                AND railway IN ('rail', 'narrow_gauge', 'light_rail') AND service = ''
            OR zoom_Level >= 14
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_aerialway_linestring_gen1
        WHERE zoom_level = 12
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_aerialway_linestring
        WHERE zoom_level >= 13
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_shipway_linestring_gen2
        WHERE zoom_level = 11
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_shipway_linestring_gen1
        WHERE zoom_level = 12
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_shipway_linestring
        WHERE zoom_level >= 13
        UNION ALL
        ...
        SELECT
            ...
            NULL as bicycle, NULL as foot, NULL as horse, NULL as mtb_scale,
            NULL AS surface, z_order
        FROM :use_schema.osm_highway_polygon
...
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text,
  ...
  text, subclass text, layer INT, level INT, indoor INT) AS $$
    ...
    FROM (
        ...
        SELECT *,
            NULL::int AS layer, NULL::int AS level, NULL::boolean AS indoor
        FROM :use_schema.osm_transportation_name_linestring_gen4
        WHERE zoom_level = 6
        UNION ALL
